    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between items-center h-14 sm:h-16">
            <div className="flex items-center gap-4 sm:gap-8">
              ...
              <div className="hidden md:flex gap-4 lg:gap-6">
                <Link href="/admin/dashboard" className="text-xs sm:text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  Dashboard
                </Link>
                <Link href="/admin/complaints" className="text-xs sm:text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  All Complaints
                </Link>
                <Link href="/admin/users" className="text-xs sm:text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  Users
                </Link>
                <Link href="/admin/analytics" className="text-xs sm:text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  Analytics
                </Link>
              </div>
            </div>
            <div className="flex items-center gap-2 sm:gap-4">
              <span className="hidden xs:inline text-xs sm:text-sm text-gray-600 truncate">Admin: {profile?.full_name}</span>
      ...
      <main className="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="mb-4 sm:mb-6">
          <Link href="/admin/dashboard" className="text-blue-600 hover:text-blue-700 flex items-center gap-2 font-medium text-sm sm:text-base">
          ...
          <div className="lg:col-span-1 space-y-4 sm:space-y-6">
            ...
            {complaint?.assigned_staff && (
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg sm:rounded-xl p-4 sm:p-6">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Assigned To</h3>
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm sm:text-base font-medium text-gray-900">{complaint.assigned_staff.full_name}</p>
                    <p className="text-xs sm:text-sm text-gray-600 break-all">{complaint.assigned_staff.email}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {/* Management Actions */}
            <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Manage Complaint</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="staff" className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">
                    Assign to Staff
                  </label>
                  <select
                    id="staff"
